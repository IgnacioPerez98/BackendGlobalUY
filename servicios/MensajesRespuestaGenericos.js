let MensajesdeRespuestaGenericos ={
    //Recibe el codigo de status http, y retorna un string con una object generico
    Obtener: function (errorCode){
        switch (errorCode){
            case 200:
...
module.exports = MensajesdeRespuestaGenericos;